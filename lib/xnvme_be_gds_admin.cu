...
int
xnvme_be_gds_sync_cmd_admin(struct xnvme_cmd_ctx *ctx, void *dbuf, size_t dbuf_nbytes,
			     void *XNVME_UNUSED(mbuf), size_t XNVME_UNUSED(mbuf_nbytes))
{
	struct xnvme_be_gds_state *state = (xnvme_be_gds_state *)ctx->dev->be.state;
...
struct xnvme_be_admin g_xnvme_be_gds_admin = {
#ifdef XNVME_BE_BAM_ENABLED
	.cmd_admin = xnvme_be_gds_sync_cmd_admin,
